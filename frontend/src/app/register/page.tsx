...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#05070A] flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          ...
          style={{
            ...
            animation: mounted ? 'float1 9s ease-in-out infinite' : 'none',
          }}
        />
        <div
          className="absolute w-[450px] h-[450px] rounded-full opacity-[0.04]"
          style={{
            background: 'radial-gradient(circle, #00aaef 0%, transparent 70%)',
            bottom: '-100px', left: '10%',
            animation: mounted ? 'float2 11s ease-in-out infinite' : 'none',
          }}
        />
        <div
      ...
      {/* Form panel */}
      <div className="flex flex-col items-center justify-center flex-1 px-4 sm:px-8 py-12 relative z-10">
        {/* Logo */}
        <div
          className="mb-8"
          style={{
          ...
          {success && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#6B7280] text-sm mt-1">Redirecting to your dashboard…</p>
              </div>
            </div>
          )}
