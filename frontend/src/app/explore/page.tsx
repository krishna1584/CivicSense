...
const STATUS_FILTERS: (IssueStatus | 'all')[] = ['all', 'reported', 'acknowledged', 'in_progress', 'resolved', 'rejected'];
  ...
  return (
    <AppLayout>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">Explore Issues</h1>
          <p className="text-[#6B7280] text-sm mt-1">Browse and track civic issues reported by your community</p>
        </div>
        <Link href="/report"
