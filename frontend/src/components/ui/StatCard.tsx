...
export function StatCard({ label, value, icon, trend, accent = 'green', suffix }: StatCardProps) {
  ...
  return (
    <div className="card p-5 group flex flex-col justify-between min-h-[130px] relative overflow-hidden">
      ...
      <div className="flex items-baseline gap-2 relative z-10 mt-auto">
        <span className="text-3xl font-bold text-content-primary tracking-tight animate-fade_in">
          {value}
        </span>
