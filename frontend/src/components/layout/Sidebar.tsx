...
import {
  ...
  User, Shield, BarChart2, LogOut, Hexagon
} from 'lucide-react';
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-base-900 border-r border-border-subtle flex flex-col z-50">
      ...
      {user && (
        <div className="p-4 border-t border-border-subtle/50">
          <div className="flex items-center gap-3 px-3 py-2 mb-3 bg-base-850 rounded-xl border border-border-subtle/50">
            <div className="w-9 h-9 rounded-lg bg-accent-secondary/10 flex items-center justify-center text-accent-secondary font-bold text-sm border border-accent-secondary/20">
